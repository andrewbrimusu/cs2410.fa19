public class MACDStrategy extends StockMarketStrategy {
    String strategyName;
    MACDStrategy(String account) {
    ...
    public void runStrategy(StockMarketStrategy account) {
        ...
        for (int day = numDays; day < stockMarketData.getNumStocks(); day++){ //loops through process for amount of stocks
            ...
            if(prc > meanPrc && !hasStock){ // buys stock
                account.setBuy(prc);
            ...
            } else if(prc < meanPrc && hasStock){ //sells stock
