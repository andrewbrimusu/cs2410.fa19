...
// 4.Demo Fade
// - speed up fade
// - add changing colors to fade with timeline
// - adjust color change to be a new color when it disappears
//GOTO ClockAnimation.java
...
public class FadeTransitionDemo extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Timeline tl = new Timeline(new KeyFrame(Duration.millis(1000), e-> {
            ellipse.setFill(Color.rgb((int)(Math.random()*255),(int)(Math.random()*255),(int)(Math.random()*255)));
        }));
        tl.setCycleCount(10);
        tl.play();
